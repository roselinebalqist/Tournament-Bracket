        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-gray-400">
                    Buat turnamen baru dan atur format pendaftarannya.
                </p>
            </div>
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-3xl p-8 shadow-2xl shadow-indigo-500/10">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-400">
                    Diharapkan peserta dapat mengisi informasi turnamen dengan benar. 
                </p>
            </div>
            ...
            <form action="{{ route('admin.tournaments.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description"
                              ...
                              class="w-full rounded-2xl border shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="max_participants"
                            ...
                            <option value="4" @selected(old('max_participants') == 4)>4 Tim</option>
                            <option value="8" @selected(old('max_participants') == 8)>8 Tim</option>
                            <option value="16" @selected(old('max_participants') == 16)>16 Tim</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="registration_open" @selected(old('status') === 'registration_open')>Registration Open</option>
                            <option value="registration_closed" @selected(old('status') === 'registration_closed')>Registration Closed</option>
